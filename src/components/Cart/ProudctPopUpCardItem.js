  ...
  return (
    <div className="flex gap-2 items-center my-3">
      <div className="w-[20%] relative">
        <div className="absolute top-0 left-0 z-10 bg-white p-1 rounded-full border cursor-pointer hover:bg-blue-500 hover:text-white" title="Remove">
          <IoCloseSharp />
        </div>
        <div className="relative w-[90%] m-auto h-[90px]">
